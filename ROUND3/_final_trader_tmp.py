...
# Ladder block skew (0 = off).
BLOCK_RISK_SKEW_K = 0.18

# PROCESS_LOG: 6000/6500 are almost static. Set USE_WING_THROTTLE = True to match baseline.
USE_WING_THROTTLE = True
