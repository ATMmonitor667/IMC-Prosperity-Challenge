...
class Trader:
    """
    IMC Prosperity 4 Round 5 v13 peak-window refinement.
    ...
    - Adds sharper deterministic product time-stops calibrated from the strong v12 run to capture peak windows.
    ...
    # Deterministic time-stop risk overlay from v10 trajectory analysis.
    # These products produced large mid-run peaks and then gave back substantial PnL.
    # A static stop avoids the v11 mistake of tracking own-trade PnL inside traderData.
    TIME_STOPS = {
        # v13 peak-window stops. These keep v10/v12 execution intact but stop products
        # at the timestamp windows where the v12 run showed their edge was highest.
        # The goal is to cut post-peak giveback without touching the main winner fill profile.
        "TRANSLATOR_GRAPHITE_MIST": 20900,
        "SNACKPACK_STRAWBERRY": 59500,
        "SLEEP_POD_POLYESTER": 60400,
        "SNACKPACK_VANILLA": 60400,
        "SNACKPACK_PISTACHIO": 62000,
        "UV_VISOR_MAGENTA": 62900,
        "ROBOT_VACUUMING": 70800,
        "GALAXY_SOUNDS_SOLAR_FLAMES": 76600,
        "ROBOT_MOPPING": 89500,
        "SLEEP_POD_NYLON": 59700,
        "SLEEP_POD_SUEDE": 95800,
        "GALAXY_SOUNDS_SOLAR_WINDS": 96600,
        "TRANSLATOR_ASTRO_BLACK": 97200,
        "PEBBLES_L": 96400,
        "UV_VISOR_AMBER": 37000,
        "PEBBLES_XL": 94000,
        "PANEL_4X4": 96800,
        "MICROCHIP_SQUARE": 99200,
        "OXYGEN_SHAKE_CHOCOLATE": 96600,
        "MICROCHIP_CIRCLE": 95400,
        "MICROCHIP_OVAL": 50500,
    }
    ...
    def _time_stopped(self, product: str, timestamp: int) -> bool:
        stop = self.TIME_STOPS.get(product)
        return stop is not None and timestamp >= stop
    ...
    def run(self, state: TradingState):
        ...
        for product, depth in state.order_depths.items():
            ...
            if product in self.AVOID or self._time_stopped(product, state.timestamp):
