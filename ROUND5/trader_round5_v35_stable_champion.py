...
class Trader:
    """
    IMC Prosperity 4 Round 5 v35 stable champion rollback.
    ...
    v35 decision after failed v34 run:
    - Remove the v34 delayed fill-quality recovery loop because it pushed the score back under 30k.
    - Keep the v33 protected participation core that reached 31.4k.
    - Do not add new traderData state, quote-size boosters, timestamp exits, or branch overrides.
    - Treat v34 as failed evidence and return to the last validated non-overfit architecture.
    """
