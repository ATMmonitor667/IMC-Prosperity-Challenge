...
class Trader:
    """
    IMC Prosperity 4 Round 5 v33 participation-guarded trend-escape.
    ...
    def _combine_alpha(
        ...
        # During a v33 trend-escape condition, reduce much less because the alpha has already
        # been re-centered toward the persistent move.
        if product not in self.TREND_NAMES and rv * trend < 0 and abs(trend) > 1.1:
            alpha *= 0.86 if trend_escape else 0.60
