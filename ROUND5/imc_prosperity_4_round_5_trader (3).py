...
class Trader:
    ...
    Changes versus the original 18k-PnL bot:
    ...
    - Adds product priors from the two uploaded runs: strong names get size, repeated toxic
      names are flattened/ignored, uncertain names are traded small.
